...
<CardGroup cols={2}>
  ...
  <Card title="Recommendations" icon="thumbs-up" href="/api-reference/rest/recommendations/recommendations/recommend-points">
    Get point recommendations based on positive and negative examples.
  </Card>
  <Card title="Discovery" icon="compass" href="/api-reference/rest/recommendations/discovery/discover-points">
    Discover points using context pairs for similarity exploration.
  </Card>
  <Card title="Grouped search" icon="object-group" href="/api-reference/rest/grouped-search/grouped-search/search-with-grouping">
  ...
  <Card title="Snapshots and maintenance" icon="database" href="/api-reference/rest/snapshots/snapshots/list-snapshots">
...
For a more ergonomic development experience with type safety and automatic connection management, consider using the [Python SDK](/sdks/python/index). The SDK communicates over gRPC (port 50051) and provides the same operations available through the REST API.
