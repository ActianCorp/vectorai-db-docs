---
title: "Installation"
description: "Install the JavaScript SDK with npm install @actian/vectorai-client."
---
...
For all client configuration options, see the [JavaScript SDK reference](/sdks/javascript/reference).
