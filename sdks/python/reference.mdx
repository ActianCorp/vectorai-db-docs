...
sidebarTitle: "Python reference"
description: "Core Python SDK clients, namespaces, configuration, filters, batching, and errors."
---

The Python SDK package is `actian-vectorai-client`; import APIs from `actian_vectorai_client`.
...
```python
from actian_vectorai_client import VectorAIClient, AsyncVectorAIClient
...
```python
from actian_vectorai_client import Settings, settings
...
```python
from actian_vectorai_client import VectorAIClient, VectorParams, Distance, PointStruct
...
```python
from actian_vectorai_client import Field, FilterBuilder
...
```python
from actian_vectorai_client import reciprocal_rank_fusion, distribution_based_score_fusion
