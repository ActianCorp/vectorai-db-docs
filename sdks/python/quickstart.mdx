...
<Warning>
**VectorAI DB Required**: This quickstart requires VectorAI DB running in a Docker container. Docker deployment is the only supported version at the moment. [Set up VectorAI DB locally →](/docs/installation/docker)
</Warning>
