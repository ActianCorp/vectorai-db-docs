...
- **Python 3.9+** with `pip`
- **VectorAI DB** running at `localhost:6574` (see [Docker installation](/home/installation/instructions) for setup)
- **OpenAI API key** — set as the `OPENAI_API_KEY` environment variable

Install the required Python packages:

```bash
pip install actian-vectorai-client openai fastapi uvicorn websockets
```
