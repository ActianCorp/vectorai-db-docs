...
Facial recognition systems are built as multi-stage pipelines, where each component transforms raw images into searchable representations. The following concepts are foundational to how these systems operate at scale:
...
<CardGroup cols={2}>
  <Card title="Vector database fundamentals" href="/docs/fundamentals/index">
