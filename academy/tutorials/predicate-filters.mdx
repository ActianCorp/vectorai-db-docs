...
<CardGroup cols={2}>
  <Card title="Hybrid search patterns" href="/academy/tutorials/hybrid-search">
  ...
  <Card title="Filtering with boolean logic" href="/academy/tutorials/filtering-boolean-logic">
    Add `must`, `should`, and `must_not` conditions
  </Card>
  <Card title="Geospatial search" href="/academy/tutorials/geospatial-search">
