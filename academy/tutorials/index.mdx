...
<CardGroup cols={2}>
  ...
  <Card title="Build a RAG pipeline" href="/academy/tutorials/simple-rag-pipeline">
...
| 4 | [Build a RAG pipeline](/academy/tutorials/simple-rag-pipeline) | Document chunking, retrieval, LLM integration |
| 5 | [Use open-source embedding models](/academy/tutorials/leverage-open-source-embedding-models) | Model selection, dimensionality, quantization |
| 6 | [Build multi-modal systems](/academy/tutorials/multimodel-system) | Named vectors, multi-stage prefetch, fusion |
| 7 | [Re-rank search results](/academy/tutorials/re-ranking) | Two-stage retrieval, cross-encoders, result optimization |
| 8 | [Optimize retrieval quality](/academy/tutorials/retrieval-quality) | Evaluation metrics, HNSW tuning, benchmarking |
| 9 | [Build adaptive RAG systems](/academy/tutorials/adaptive-rag) | Query classification, dynamic retrieval, self-correction |
