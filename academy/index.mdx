...
<CardGroup cols={3}>
 ...
 Build RAG pipelines that automatically adapt their retrieval strategy based on query complexity.
  ...
  <Card title="Full collection workflow" href="/academy/tutorials/python-first-collection" icon="sliders">
 Building a full collection workflow using the Python SDK.
 </Card>
</CardGroup>
