...
<Warning>
**Python SDK Required**: To verify your installation, you need to have the VectorAI Python SDK installed. Install it using `pip install actian-vectorai` or follow the [Python SDK quickstart](/sdks/python/quickstart).
</Warning>
