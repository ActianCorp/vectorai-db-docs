...
This example assumes a `documents` collection already exists with indexed points. For collection setup, see [Fusion methods](/docs/fundamentals/hybrid-search/fusion-methods).
