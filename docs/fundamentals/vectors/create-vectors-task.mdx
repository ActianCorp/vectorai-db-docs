...
<Note>
Before you begin, make sure you have a running VectorAI DB instance and the Python client library installed (`pip install actian-vectorai-client`). The examples on this page use random vectors for demonstration. In production, generate vectors from an embedding model.
</Note>
