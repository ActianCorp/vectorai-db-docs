...
<Note>
You need an existing collection. Vectors must match the dimension configured for the collection. See [Create a collection](/docs/fundamentals/collections/create-collection-task) to set one up.
</Note>
