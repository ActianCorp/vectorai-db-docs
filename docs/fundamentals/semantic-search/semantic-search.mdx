---
title: "Overview"
description: "Semantic search in Actian VectorAI DB finds documents by meaning rather than keywords. Covers embedding-based retrieval, payload filtering, score thresholds, and multi-constraint search patterns for RAG pipelines."
---
...
| Multi-constraint search | Vector similarity with multiple metadata conditions combined. | Complex queries that require both category and range restrictions. |
...
- [Multi-constraint search](/docs/fundamentals/semantic-search/multi-constraint-search-task)
