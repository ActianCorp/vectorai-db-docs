...
<Warning>
**Docker Compose required**: The Local UI is  available only when VectorAI DB is running via Docker Compose. Ensure your stack is up before accessing the interface. [Setup instructions →](/home/installation/instructions)
</Warning>
