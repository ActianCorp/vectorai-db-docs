...
<Warning>
**Docker Compose required**: The LocalUI is  available only when VectorAI DB is running via Docker Compose. Ensure your stack is up before accessing the interface. [Setup instructions →](/docs/installation/docker)
</Warning>
