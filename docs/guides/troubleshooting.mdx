...
<CardGroup cols={2}>
  ...
  <Card title="Docker setup" icon="docker" href="/home/installation/instructions">
    Container setup, volume mounts, and Docker Compose configuration.
  </Card>
  <Card title="HNSW indexing" icon="chart-network" href="/docs/fundamentals/indexing/indexing">
