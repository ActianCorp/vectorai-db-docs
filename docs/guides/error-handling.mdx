...
| | |
|---|---|
| **SDK exceptions** | `actian_vectorai_client.exceptions` module |
...
from actian_vectorai_client import VectorAIError, get_retry_delay, is_retryable
...
```python
from actian_vectorai_client import VectorAIError
