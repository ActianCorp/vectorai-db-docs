---
title: "LlamaIndex"
description: "Use Actian VectorAI DB as a vector store in LlamaIndex for building RAG pipelines, semantic search, and AI-powered applications."
---
...
```python
from actian_vectorai_client import VectorParams, Distance
