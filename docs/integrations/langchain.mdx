---
title: "LangChain"
description: "Use Actian VectorAI DB as a vector store in LangChain for building RAG pipelines, semantic search, and AI-powered applications."
---
...
- A running Actian VectorAI DB instance (default endpoint: `localhost:50051`). See [Docker installation](/docs/installation/docker) for setup instructions.
...
- [OpenAI embeddings](/docs/integrations/openai-embedding-model) — Configure OpenAI as your embedding provider.
