...
HNSW (Hierarchical Navigable Small World) provides ultra-fast k-NN queries. Flat indexing offers exact brute-force search for smaller datasets. These algorithms balance speed with accuracy trade-offs.
</Step>
...
| **Indexing** | B-trees, hash indexes | HNSW, flat, auto for vector spaces |
