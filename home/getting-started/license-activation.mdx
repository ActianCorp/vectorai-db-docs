...
<Note>
  Your key is emailed when you start a trial or purchase a subscription. Don't have one yet? [Start a free 30-day trial](https://www.actian.com/databases/vectorai-db/community-edition/), no credit card required. If you haven't received your key, contact [Actian support](https://www.actian.com/support).
</Note>
