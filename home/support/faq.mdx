...
By default, the REST API runs on port `6575` and the gRPC API runs on port `6574`. For deployment configuration details, see the [Docker installation guide](/docs/installation/docker).
