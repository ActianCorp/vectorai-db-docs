...
By default, the REST API runs on port `6573`, the gRPC API on port `6574`, and Local UI on port `6575`. For deployment configuration details, see the [Docker installation guide](/home/installation/instructions).
