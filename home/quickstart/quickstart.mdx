...
Before starting, make sure VectorAI DB is running and your SDK is installed. See the [Docker setup guide](/home/installation/instructions) if you haven't done that yet.
