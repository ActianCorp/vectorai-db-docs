...
<Note>
    The Community Edition of VectorAI DB is free to use with up to 5,000 vectors. Need more? [Sign up for a 30-day free trial](https://www.actian.com/databases/vectorai-db/community-edition/) and scale up to 1 million vectors.
</Note>
